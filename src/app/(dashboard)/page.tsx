...
const quickAccess = [
  { name: "Criar Vaga", href: "/agents/criador-descricao-vagas", category: "Recrutamento" },
  { name: "Plano Onboarding", href: "/agents/criador-plano-onboarding", category: "Onboarding" },
  { name: "Feedback Estruturado", href: "/agents/gerador-feedbacks-estruturados", category: "Avaliação" },
  { name: "Pesquisa de Clima", href: "/agents/pesquisa-clima", category: "Clima e Cultura" },
];
            ...
            <CardContent className="p-0">
              <div className="divide-y">
                {stats.recentExecutions.map((exec) => (
                  <Link
                    key={exec.id}
                    href={`/history?execution=${exec.id}`}
                    className="block"
                  >
