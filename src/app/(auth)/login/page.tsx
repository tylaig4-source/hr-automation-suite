    ...
    <div className="min-h-screen flex bg-[#0a0a0f]">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 relative z-10">
        <div className="max-w-lg">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neon-cyan/30 bg-neon-cyan/10 text-neon-cyan text-sm font-medium mb-8">
            <Bot className="w-4 h-4" />
            <span>34 agentes de IA especializados</span>
          </div>
          ...
          <p className="text-xl text-gray-400 mb-10">
            Transforme horas de trabalho em minutos com nossos agentes especializados.
          </p>
          
          <div className="space-y-4">
            {[
              "Descrições de vagas em 2 minutos",
              "Análise de currículos automatizada",
              "Planos de onboarding personalizados",
              "Economia de até 95% do tempo"
            ].map((item, i) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass rounded-3xl p-8 border border-white/10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 rounded-xl bg-gradient-to-r from-neon-cyan to-neon-magenta text-black font-semibold hover:opacity-90 transition-opacity" 
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
